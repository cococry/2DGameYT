...
namespace game {
    ...
    void window::init(const windowProperties& props) {
        ...
        mGLFWInstance = glfwCreateWindow(props.width, props.height, props.title,
                                         props.startFullscreen ? glfwGetPrimaryMonitor() : nullptr, nullptr);
        ...
        glfwSetKeyCallback(mGLFWInstance, input::glfwKeyCallback);

        glfwSetMouseButtonCallback(mGLFWInstance, input::glfwMouseButtonCallback);

        glfwSetCursorPosCallback(mGLFWInstance, input::glfwCursorPosCallback);

        glfwSetScrollCallback(mGLFWInstance, input::glfwScrollCallback);
    }
